...
function App() {
  ...
  const processImage = useCallback((img, currentSettings) => {
    ...
    // 计算缩放比例
    const scale = currentSettings.size / Math.max(img.width, img.height);
    ...
    const result = proImageToPixelGrid(imageData, width, height, currentSettings.colorCount, targetSize);
